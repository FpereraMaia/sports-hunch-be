...
from v1.ranking.viewsets import GenerateRankingViewSet, CurrentRankingViewSet, RankingHistoryViewSet
from v1.standings.viewsets import CurrentStandingsViewSet, CreateStandingsViewSet

router = routers.DefaultRouter()

router.register(r'championship/standings', CreateStandingsViewSet, basename="CreateStandingsViewSet")
router.register(r"championship/standings/current", CurrentStandingsViewSet, basename="CurrentStandingsViewSet")

router.register(r"bet/ranking/history", RankingHistoryViewSet, basename="CurrentRankingViewSet")
